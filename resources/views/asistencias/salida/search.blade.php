@if(count($asistencia_salida) > 0)
<div class="table-responsive" id="table-salida-ajax">
...
@else
<div class="tim-tipo">
    <p>No se encontraron resultados con <b>{{$search}} @if(isset($search1)){{$search1}}@endif</b></p>
</div>
@endif